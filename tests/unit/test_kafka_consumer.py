...
class TestKafkaStreamConsumer:
    ...
    def test_consume_tle_message(self, mock_kafka_consumer):
        ...
        mock_kafka_consumer.poll.return_value = {"topic": [mock_msg]}
    ...
    def test_batch_processing(self, mock_kafka_consumer):
        ...
        consumer = KafkaStreamConsumer(
            bootstrap_servers=["localhost:9092"], topic="space_debris", batch_size=10
        )
        ...
        mock_kafka_consumer.poll.return_value = {"topic": mock_msgs}
