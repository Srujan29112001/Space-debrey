...
from space_debris_tracker.computer_vision.preprocessing.space_image import SpaceImagePreprocessor
from tests.utils import generate_image_sequence, Timer
...
class TestImagePreprocessing:
    ...
    def test_noise_reduction(self, sample_telescope_image):
        ...
        # Add extra noise
        noisy = sample_telescope_image + np.random.randint(-20, 20, sample_telescope_image.shape, dtype=np.int16)
